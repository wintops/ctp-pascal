...
//查询最大报单数量请求
//a TRADEAPI_API int ReqQueryMaxOrderVolume(CThostFtdcTraderApi* pApi, int requestID, CThostFtdcQueryMaxOrderVolumeField *pMaxOrderVolume)
//{
	//if (pApi == NULL) return -1;
...
//a TRADEAPI_API void WINAPI RegRspQueryMaxOrderVolume(CTraderSpi* pSpi, CBRspQueryMaxOrderVolume cb)	//查询最大报单数量响应
//{
